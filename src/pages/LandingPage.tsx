            ...
            <section className="py-24 bg-slate-50 border-t border-gray-100">
                <div className="container mx-auto px-6 lg:px-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { name: "الأساسية", price: "899", role: "للملاك الأفراد", feat: ["إدارة حتى 30 وحدة", "3 مستخدمين", "إدارة العقود وإصدار PDF", "دفع إلكتروني", "تنبيهات تجديد العقود", "لوحة تحكم عصرية"], rec: false },
                            { name: "المتقدمة", price: "1,899", role: "للشركات العقارية", feat: ["120 وحدة عقارية", "10 مستخدمين", "نظام صيانة متكامل", "تحليلات AI (تسعير+إشغال)", "تقارير مالية شهرية", "فواتير تلقائية PDF", "دعم فني ذو أولوية"], rec: true },
                            { name: "الشركات", price: "3,499", role: "للمؤسسات الكبرى", feat: ["وحدات غير محدودة", "مستخدمين غير محدودين", "ربط برمجي (API)", "نظام صلاحيات متقدم", "إدارة الفنيين والصيانة", "تحليلات مالية شاملة", "دعم فني Premium"], rec: false },
                            { name: "Arkan AI", price: "599", role: "إضافة ذكية", feat: ["محرك تسعير ذكي", "توقعات نسب الإشغال", "تحليل مخاطر المستأجرين", "تنبيهات مالية ذكية"], rec: false, addon: true }
                        ].map((p, i) => (
                            <div
                                key={i}
